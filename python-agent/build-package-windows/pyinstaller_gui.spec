...
a = Analysis(
    ...
    hiddenimports=[
        'tkinter',
        'tkinter.ttk',
        '_tkinter',  # C extension for tkinter
        'webbrowser',
        'threading',
        'subprocess',
        'pathlib',
...
exe = EXE(
    ...
    upx_exclude=[],
    runtime_tmpdir=None,
    console=False,  # Windowed mode - no console window (ẩn terminal cho khách hàng)
    disable_windowed_traceback=False,
    argv_emulation=False,
    target_arch=None,
    codesign_identity=None,
    entitlements_file=None,
    icon=None,  # You can add icon file here if you have one
)
