...
export default function UserDeviceEdit({ device }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        screen_size: device.screen_size || { width: null, height: null },
    ...
    return (
        <UserLayout title="Chỉnh sửa thiết bị">
            <Head title="Chỉnh sửa thiết bị" />
